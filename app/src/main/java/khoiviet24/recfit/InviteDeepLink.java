 ...
 */
public class InviteDeepLink extends AppCompatActivity implements
        View.OnClickListener {

    private static final String TAG = InviteDeepLink.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_invite_deep_link);
